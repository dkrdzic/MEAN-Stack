...
export class PasswordResetComponent implements OnInit {
  ...
  passwordReset() {
    ...
    if (
      this.emptyField(this.newPassword) ||
      this.emptyField(this.oldPassword) ||
      this.emptyField(this.confirmNewPassword)
    ) {
    ...
    this.userService
      .passwordReset(this.newPassword, this.oldPassword, user)
      .subscribe((data: { flag: boolean; poruka: string }) => {
        this.a = data.flag;
