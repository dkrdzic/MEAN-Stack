...
router.route("/users").get(async(req, res) => {
    ...
    let p1 = new Promise((resolve, reject) => {
        connection.once("open", () => {
            console.log(
                "MongoDB database connection established successfully!get acceptedUsers"
            );
            resolve();
...
router.get("/getRequests", async(req, res) => {
    ...
    let p1 = new Promise((resolve, reject) => {
        connection.once("open", () => {
            console.log(
                "MongoDB database connection established successfully! getRequest"
            );
            resolve();
            console.log("Promise resolved");
        });
...
router.post("/registration", upload.single("profileImg"), async(req, res) => {
    ...
    let p1 = new Promise((resolve, reject) => {
        connection.once("open", () => {
            console.log(
                "MongoDB database connection established successfully registration"
            );
            resolve();
            console.log("Promise resolved");
        });
    ...
    if (req.file == null) {
        user.profileImage =
            req.protocol + "://" + req.get("host") + "/uploads/" + "generic.jpg";
    } else {
        const oldFilePath = req.file.path;

        req.file.originalname =
            user.username + path.extname(req.file.originalname).toLocaleLowerCase();
        req.file.filename =
            user.username + path.extname(req.file.originalname).toLocaleLowerCase();
    ...
    await user
        .save()
        .then((data) => {
            // u data ti je odgovor tj ono sto je sacuvano
...
router.post("/login", async(req, res) => {
    ...
    let p1 = new Promise((resolve, reject) => {
        connection.once("open", () => {
            console.log(
                "MongoDB database connection established successfully! login"
            );
            resolve();
            console.log("Promise resolved");
        });
...
router.post("/passwordForget", async(req, res) => {
    ...
    let p1 = new Promise((resolve, reject) => {
        connection.once("open", () => {
            console.log(
                "MongoDB database connection established successfully password forget!"
            );
            resolve();
            console.log("Promise resolved");
        });
    ...
    await User.findOne({ email: req.body.email }, (err, user) => {
        if (user) {
            sendMail(
                req.body.email,
                "Promena lozinke",
                "Idite na link i promenite lozinku " + req.body.link
            );
            res.json({ user: user, poruka: "Email je uspesno poslat!", flag: true });
        } else {
            res.json({
                user: null,
                poruka: "Ne postoji korisnik sa datom email adresom",
                flag: false,
            });
        }
        if (err) {
...
function sendMail(to, subject, text) {
    ...
    transporter.sendMail(mailOptions, function(error, info) {
        if (error) console.log(error + " HEJ");
    });
}
...
router.post("/passwordReset", async(req, res) => {
    ...
    let p1 = new Promise((resolve, reject) => {
        connection.once("open", () => {
            console.log(
                "MongoDB database connection established successfully! passwordReset"
            );
            resolve();
            console.log("Promise resolved");
        });
    ...
    await User.findOne({ username: req.body.user.username },
        async(err, user) => {
            if (user) {
                if (user.password == req.body.oldPassword) {
                    await User.updateOne({ username: req.body.user.username }, { password: req.body.newPassword },
                        (err) => {
                            if (err) res.status(400);
                            else
                                res.json({ flag: true, poruka: "Lozinka uspesno promenjena!" });
                        }
                    );
                } else {
                ...
                res.json({ flag: false, poruka: "Korisnik ne postoji!" });
            }
        }
    );
...
router.get("/books", async(req, res) => {
    ...
    let p1 = new Promise((resolve, reject) => {
        connection.once("open", () => {
            console.log(
                "MongoDB database connection established successfully! books"
            );
            resolve();
            console.log("Promise resolved");
        });
...
router.post("/requestAccept", async(req, res) => {
    ...
    let p1 = new Promise((resolve, reject) => {
        connection1.once("open", () => {
            console.log(
                "MongoDB database connection established successfully requestAccept!"
            );
            resolve();
            console.log("Promise resolved");
        });
    ...
    let p2 = new Promise((resolve, reject) => {
        connection2.once("open", () => {
            console.log(
                "MongoDB database connection established successfully requestaccept 2!"
            );
            resolve();
            console.log("Promise resolved");
        });
...
router.post("/changePrivilege", async(req, res) => {
    ...
    let p1 = new Promise((resolve, reject) => {
        connection.once("open", () => {
            console.log(
                "MongoDB database connection established successfully changePrivilege!"
            );
            resolve();
            console.log("Promise resolved");
        });
    ...
    await User.updateOne({ username: user.username }, { userType: type },
        (err) => {
            if (err) res.status(400).json(null);
            else {
                res.json(true);
...
router.post("/addBook", upload.single("profileImg"), async(req, res) => {
    ...
    let p1 = new Promise((resolve, reject) => {
        connection.once("open", () => {
            console.log(
                "MongoDB database connection established successfully addBook"
            );
            resolve();
            console.log("Promise resolved");
        });
    ...
    if (req.file == null) {
        ...
        req.file.originalname =
            book.id + path.extname(req.file.originalname).toLocaleLowerCase();
        req.file.filename =
            book.id + path.extname(req.file.originalname).toLocaleLowerCase();
        req.file.path = "uploads\\" + req.file.originalname;
    ...
    if (book.pages == null || book.pages == undefined) book.pages = 100;
...
router.get("/getGanres", async(req, res) => {
    mongoose.connect("mongodb://localhost:27017/ganres", {
        useNewUrlParser: true,
        useUnifiedTopology: true,
    });
    ...
    let p1 = new Promise((resolve, reject) => {
        connection.once("open", () => {
            console.log(
                "MongoDB database connection established successfully! ganres"
            );
            resolve();
            console.log("Promise resolved");
        });
...
router.post("/addGanre", async(req, res) => {
    ...
    let p1 = new Promise((resolve, reject) => {
        connection.once("open", () => {
            console.log(
                "MongoDB database connection established successfully! addganre"
            );
            resolve();
            console.log("Promise resolved");
        });
...
router.post("/changeUserName", async(req, res) => {
    ...
    await User.updateOne({ username: user.username }, { name: req.body.name },
        (err) => {
            if (err) res.status(400).json(false);
            else {
                res.json(true);
...
router.post("/changeUserSurname", async(req, res) => {
    ...
    await User.updateOne({ username: user.username }, { surname: req.body.surname },
        (err) => {
            if (err) res.status(400).json(false);
            else {
                res.json(true);
...
router.post("/changeUserBirthday", async(req, res) => {
    ...
    await User.updateOne({ username: user.username }, { birthday: req.body.birthday },
        (err) => {
            if (err) res.status(400).json(false);
            else {
                res.json(true);
...
router.post("/changeUserCountry", async(req, res) => {
    ...
    await User.updateOne({ username: user.username }, { country: req.body.country },
        (err) => {
            if (err) res.status(400).json(false);
            else {
                res.json(true);
...
router.post("/changeUserCity", async(req, res) => {
    ...
    await User.updateOne({ username: user.username }, { city: req.body.city },
        (err) => {
            if (err) res.status(400).json(false);
            else {
                res.json(true);
...
router.post("/changeUserUsername", async(req, res) => {
    ...
    await User.findOne({ username: req.body.username }, async(err, data) => {
        if (data) {
            ...
            await User.updateOne({ username: user.username }, { username: req.body.username },
                (err, data) => {
                    if (err) {
                        console.log(err);
                        res.json(null);
...
router.post("/changeUserEmail", async(req, res) => {
    ...
    await User.findOne({ email: req.body.email }, async(err, data) => {
        if (data) {
            ...
            await User.updateOne({ username: user.username }, { email: req.body.email },
                (err, data) => {
                    if (err) {
                        console.log(err);
                        res.json(null);
...
router.post("/changeImg", upload.single("profileImg"), async(req, res) => {
    ...
    await User.updateOne({ username: user.username }, { profileImage: user.profileImage },
        (err) => {
            if (err) res.status(400).json(null);
            else {
...
router.post("/updateBookPage", async(req, res) => {
    ...
    await Page.updateOne({ username: req.body.username, idBook: req.body.idBook }, { page: req.body.page },
        (err) => {}
    );
...
router.post("/findPages", async(req, res) => {
    ...
    await Page.findOne({ username: req.body.username, idBook: req.body.idBook },
        (err, page) => {
            if (page) {
                res.json(page);
            } else res.json(null);
...
router.post("/changeComment", async(req, res) => {
    ...
    await Comment.updateOne({ id: comment.id }, { comment: req.body.updateComment },
        (err) => {
...
router.post("/updateNotifications", async(req, res) => {
    ...
    await User.updateOne({ username: user.username }, { notifications: user.notifications },
        (err, data) => {
            if (err) {
                console.log(err);
                res.json(false);
...
router.post("/makeHappening", async(req, res) => {
    mongoose.connect("mongodb://localhost:27017/happenings", {
        useNewUrlParser: true,
        useUnifiedTopology: true,
    });
...
router.post("/updateHappening", async(req, res) => {
    ...
    await Happening.updateOne({ id: req.body.id }, { active: req.body.active },
        (err, data) => {
            if (err) {
                console.log(err);
                res.json(false);
...
router.post("/changeCover", upload.single("profileImg"), async(req, res) => {
    ...
    await Book.updateOne({ id: book.id }, { coverImage: book.coverImage },
        (err) => {
            if (err) res.status(400).json(null);
            else {
                res.json(true);
...
router.post("/changeBookDescr", async(req, res) => {
    ...
    await Book.updateOne({ id: book.id }, { description: req.body.newDescr },
        (err) => {
            if (err) res.status(400).json(false);
            else {
                res.json(true);
...
router.post("/makeRating", async(req, res) => {
    ...
    await Rating.findOne({ username: rating.username, bookId: rating.bookId },
        async(err, r) => {
            if (r != null) {
                console.log("k");
                await Rating.updateOne({ username: rating.username, bookId: rating.bookId }, { note: rating.note },
                    (err) => {}
                );
                console.log("KK");
                res.json(r);
...
router.post("/rateBook", async(req, res) => {
    ...
    await Book.updateOne({ id: book.id }, { rating: book.rating, n: book.n },
        (err) => {
            if (err) {
                console.log(err);
                res.json(false);
...
router.route("/followHappening").post(async(req, res) => {
    ...
    await Happening.updateOne({ id: happening.id }, { followers: happening.followers },
        (err, data) => {
            if (data) {
                res.json(true);
                console.log(data);
